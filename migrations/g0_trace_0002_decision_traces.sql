-- FR-TRACE-005: content-addressed, point-in-time decision authorization traces.
...
-- Rollback: DROP TABLE trace.decision_traces; only before any released decision exists.
