...
CREATE TABLE economic_trade_events (
    ...
    CONSTRAINT economic_trade_events_unresolved_actor_reduced
        CHECK (actor_resolution_state <> 'UNRESOLVED' OR contribution_factor < 1),
    CONSTRAINT economic_trade_events_unresolved_actor_quality
        CHECK (actor_resolution_state <> 'UNRESOLVED'
               OR 'SYSTEM_ADDRESS_UNCERTAIN' = ANY (quality_codes)),
