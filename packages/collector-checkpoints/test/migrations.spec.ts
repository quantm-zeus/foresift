/**
 * SQL-truth structural rules for collector-checkpoints migrations.
 */
...
describe('g0_col_* SQL migrations (collector-checkpoints)', () => {
  it('discovers collector checkpoint and gap migrations in order', async () => {
