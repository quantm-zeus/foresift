/**
 * SQL-truth structural rules for collector-gap-recovery migrations.
 */
...
describe('g0_col_* SQL migrations (collector-gap-recovery)', () => {
  it('discovers collector gap migrations in order', async () => {
