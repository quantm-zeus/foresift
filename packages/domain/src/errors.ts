...
export const ErrorCode = {
  ...
  // --- free-first cost and sustainable capacity (FR-COST-001…010)
  ...
  COST_DECLARATION_UNKNOWN: 'COST_DECLARATION_UNKNOWN',
  COST_PLAN_UNVERIFIED: 'COST_PLAN_UNVERIFIED',
  COST_POLICY_IMMUTABLE: 'COST_POLICY_IMMUTABLE',
  COST_POLICY_INADMISSIBLE: 'COST_POLICY_INADMISSIBLE',
