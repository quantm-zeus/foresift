...
// Package-local runner config for `pnpm --filter @foresift/domain test`.
...
// this package's colocated `test/` suites. Timeouts mirror the root
// per-project budgets (a hung test still fails; only load-dependent false reds
// are removed).
