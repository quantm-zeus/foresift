...
export function compareChampionChallenger(input: {
  ...
  return Object.freeze({
    ...
    promotionEligible:
      lift >= input.minimumLift && input.challenger.metricValue > input.modelRemovedBaselineMetric,
  });
}
