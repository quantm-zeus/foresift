 ...
 * entry MUST belong to a known `<generation>_(data|dr|sec|prov|core|cost|col|disc|mcp|trace|sig|solsec|trd|sup|exec|mat|eval)_<4-digit-seq>_<name>`
...
export interface MigratorOptions {
  ...
  /** Directory containing `g<generation>_(data|dr|sec|prov|core|cost|col|disc|mcp|trace|sig|solsec|trd|sup|exec|mat|eval)_*.sql` scripts. */
