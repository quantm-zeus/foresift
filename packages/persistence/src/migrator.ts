 ...
 * `migrations/g<generation>_(data|dr|sec|prov|core|cost|col|disc|mcp|trace|sig|solsec|trd|sup)_*.sql`.
 *
 ...
 *   `<generation>_(data|dr|sec|prov|core|cost|col|disc|mcp|trace|sig|solsec|trd|sup|exec)_<seq>_<name>` family is refused
...
// `trd` (economic trades), `solsec` (Solana security), and `sup` (supply confidence).
 ...
 * entry MUST belong to a known `<generation>_(data|dr|sec|prov|core|cost|col|disc|mcp|trace|sig|solsec|trd|sup|exec)_<4-digit-seq>_<name>`
...
export interface MigratorOptions {
  ...
  /** Directory containing `g<generation>_(data|dr|sec|prov|core|cost|col|disc|mcp|trace|sig|solsec|trd|sup|exec)_*.sql` scripts. */
