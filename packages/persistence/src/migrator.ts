...
// `cost` (cost, quota, and capacity controls), `mcp` (MCP transport state).
// Unknown families stay refused fail-closed.
const MIGRATION_FILE_PATTERN = /^g\d+_(data|dr|sec|prov|core|cost|col|disc|mcp)_\d{4}_[a-z0-9_]+\.sql$/;
