 ...
 *   `<generation>_(data|dr|sec)_<seq>_<name>` family is refused
...
// `sec` (security perimeter), `prov` (provider lifecycle truth).
 ...
 * entry MUST belong to a known `<generation>_(data|dr|sec|prov)_<4-digit-seq>_<name>`
...
export interface MigratorOptions {
  ...
  /** Directory containing `g<generation>_(data|dr|sec)_*.sql` scripts. */
