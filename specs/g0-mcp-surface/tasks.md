...
- [ ] T001 [P] Scaffold the `apps/api` workspace package: `package.json` (`@foresift/api`,
      ...
      **FR-MCP-001** — AC-001
- [ ] T002 [P] Add `packages/shared-schemas/src/mcp.ts` (MCP output envelope, session binding,
      ...
      **FR-MCP-003** — AC-002
- [ ] T003 Add `migrations/g0_mcp_0001_sessions.sql` (session rows bound to
...
- [ ] T011 Implement credential lifecycle endpoints/operations: issue (once-only secret
...
- [ ] T026 [P] Add `telemetry/mcp.catalog.json` (declarative catalog: `mcp.*` events — surface
...
- [ ] T028 Close the traceability matrix below and confirm the material decisions of this plan
