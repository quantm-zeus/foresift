...
- [ ] T001 [P] Create `packages/domain/src/disc.ts`: `DiscEntryReason` (8 members
      ...
      Colocated unit tests are authored by the test-owned task T025
...
- [ ] T003 [P] Extend `packages/shared-schemas/src/disc.ts`: Zod schemas
      ...
      test-owned task T026 (2026-09-07 ownership law). Traces: FR-DISC-006,
...
- [ ] T009 [serial-reason: SEMANTIC_DEPENDENCY] Implement
      ...
      Colocated suites authored by test-owned T028 (ownership law). Traces:
...
- [ ] T010 [serial-reason: SEMANTIC_DEPENDENCY] Implement
      ...
      Depends on T001–T005. Colocated suites authored by test-owned T028
...
- [ ] T014 [serial-reason: SEMANTIC_DEPENDENCY] Implement
      ...
      suites authored by test-owned T029 (ownership law). Traces: FR-DISC-009,
