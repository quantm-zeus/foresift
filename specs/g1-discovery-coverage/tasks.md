...
| T020 | FR-DISC-006…014                                                              | AC-110…113, AC-224…229 | tests/acceptance/AC-_.spec.ts, tests/negative/AC-_.negative.spec.ts          |
...
| T027 | FR-DISC-006…014                                                              | —                      | packages/domain/test/disc.spec.ts, packages/shared-schemas/test/disc.spec.ts |
...
- **Scope**: every predicted write lands inside writeScopes except the
  ...
  authorship lives in test-owned tasks (T015–T022 and the colocated
  domain/shared-schema suites task T027), implementation lanes carry
