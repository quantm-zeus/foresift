...
- [ ] T040 [P] [executor: TEST] Extend `tests/telemetry-catalog.spec.ts` —
      the plan-sanctioned central-parity scope exception (plan-level decision
      4) — pinning the T033 `telemetry/sig.catalog.json` to the authoritative
      schemas field-for-field. Traces: FR-SIG-001, FR-SIG-002, FR-SIG-003,
      FR-SIG-004, FR-SIG-005, FR-SIG-006, FR-SIG-009.
- [ ] T041 [P] [executor: TEST] Author the fixtures/suite files this package
