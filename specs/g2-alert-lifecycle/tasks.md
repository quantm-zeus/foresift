...
- [ ] T001 [P] Create `packages/domain/src/alert.ts`: the §26.2
...
- [ ] T003 [P] Create `packages/shared-schemas/src/alert.ts`: Zod mirrors
...
- [ ] T012 [P] Create `packages/alerts/src/policies.ts`: the immutable
...
- [ ] T013 [P] Create `packages/alerts/src/gates.ts`: the §26.3
...
- [ ] T014 [P] Create `packages/alerts/src/classification.ts`: classify a
...
- [ ] T015 [P] Create `packages/alerts/src/content.ts`: class-templated
...
- [ ] T016 [serial-reason: SEMANTIC_DEPENDENCY] Create
...
- [ ] T017 [serial-reason: SHARED_FILE] Create
...
- [ ] T018 [executor: TEST] [P] Classification/policy/content unit tests
...
- [ ] T019 [P] Create `packages/alerts/src/fingerprints.ts`: §26.4
      ...
      FR-ALERT-001, FR-ALERT-004, AC-141.
- [ ] T020 [P] Create `packages/alerts/src/lifecycle.ts`: evaluation of
...
- [ ] T021 [P] Create `packages/alerts/src/monitoring.ts`: deterministic
      ...
      AC-141.
- [ ] T022 [executor: TEST] [P] Lifecycle unit tests on PGlite with the
...
- [ ] T023 [P] Create `packages/alerts/src/metrics.ts`: per-class metric
...
- [ ] T024 [P] Create `telemetry/alert.catalog.json`: declarative event
...
- [ ] T025 [executor: TEST] [serial-reason: SHARED_FILE] Extend the
...
- [ ] T026 [executor: TEST] [P] Metrics unit tests: each class emits its
...
- [ ] T027 [executor: TEST] [P] Create `tests/fixtures/alerts/`: canonical
      ...
      FR-ALERT-003, FR-ALERT-004, FR-ALERT-005.
- [ ] T028 [executor: TEST] [P] Author `tests/acceptance/AC-140.spec.ts` + `tests/negative/AC-140.negative.spec.ts`: EARLY_WATCH and
...
- [ ] T029 [executor: TEST] [P] Author `tests/acceptance/AC-141.spec.ts` + `tests/negative/AC-141.negative.spec.ts`: material invalidation or
...
- [ ] T030 [executor: TEST] [P] Alert-scoped extends of the shared suites
...
- [ ] T031 [serial-reason: COORDINATOR_BOUNDARY] Run cross-artifact
