...
- [x] T001 [P] Create `packages/domain/src/wf.ts`: `TriggerStatus`
...
- [x] T003 [P] Create `packages/shared-schemas/src/wf.ts`: Zod mirrors
...
- [x] T015 [P] Create `packages/workflow-runtime/src/steps.ts`:
...
- [x] T016 [P] Create `packages/workflow-runtime/src/leases.ts`:
...
- [x] T017 [P] Create `packages/workflow-runtime/src/retries.ts`:
      ...
      FR-WF-007.
- [x] T018 [serial-reason: SHARED_FILE] Create
...
- [x] T019 [executor: TEST] [P] Engine-core unit tests on PGlite:
...
- [x] T020 [serial-reason: SEMANTIC_DEPENDENCY] Create
...
- [x] T023 [P] Create `packages/workflow-runtime/src/shadow.ts`:
      ...
      Traces: FR-WF-008.
- [x] T024 [P] Create `packages/workflow-runtime/src/channels.ts`:
...
- [x] T026 [executor: TEST] [P] Lifecycle unit tests on PGlite with the
...
- [x] T027 [P] Create the §25.3 trigger endpoint under
...
- [x] T028 [P] Create schedule internal handlers under
...
- [x] T029 [executor: TEST] [P] Endpoint tests: valid signed delivery
...
- [x] T030 [executor: TEST] [P] Create `tests/fixtures/wf/`:
...
- [x] T031 [executor: TEST] [P] Author `tests/acceptance/AC-010.spec.ts`
...
- [x] T032 [executor: TEST] [P] Author `tests/acceptance/AC-011.spec.ts`
...
- [x] T033 [executor: TEST] [P] Author `tests/acceptance/AC-012.spec.ts`
...
- [x] T034 [executor: TEST] [P] Author `tests/acceptance/AC-013.spec.ts`
  - `tests/negative/AC-013.negative.spec.ts`: active runs complete on
    ...
    AC-013.
- [x] T035 [executor: TEST] [P] Author `tests/acceptance/AC-014.spec.ts`
...
- [x] T036 [executor: TEST] [P] Author `tests/acceptance/AC-063.spec.ts`
...
- [x] T037 [executor: TEST] [P] Wf-scoped extends of the shared
...
- [x] T038 [P] Create `telemetry/wf.catalog.json`: declarative event
      ...
      FR-WF-008.
- [x] T039 [executor: TEST] [serial-reason: SHARED_FILE] Extend the
      ...
      Traces: FR-WF-001.
- [x] T040 [serial-reason: COORDINATOR_BOUNDARY] Run cross-artifact
