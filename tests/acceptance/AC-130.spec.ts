...
describe("AC-130: Deterministic token program and pool security analysis (positive)", () => {
  it("detects all §65.2 token controls and classifies active vs revoked authorities", () => {
    ...
    const permDelegate = vectors.find((v: any) => v.control === "PERMANENT_DELEGATE" && v.authority !== null);
    ...
    const transferHook = vectors.find((v: any) => v.control === "TRANSFER_HOOK" && v.hookProgramId !== null);
