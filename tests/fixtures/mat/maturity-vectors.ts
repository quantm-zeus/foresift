...
export const GOLDEN_MATURITY_VECTORS: readonly MaturityVectorCase[] = [
  // 1. Normal standard progression: PENDING -> PARTIALLY_MATURED -> FULLY_MATURED
  {
    ...
    transitions: [
      { step: 1, from: 'PENDING', to: 'PARTIALLY_MATURED', valid: true, trigger: 'INTERMEDIATE_WINDOW_ELAPSED' },
      { step: 2, from: 'PARTIALLY_MATURED', to: 'FULLY_MATURED', valid: true, trigger: 'HORIZON_COMPLETED_ALL_OBSERVED' },
    ],
    isTerminal: true,
  ...
  },
  {
    ...
    transitions: [
      { step: 1, from: 'PENDING', to: 'PARTIALLY_MATURED', valid: true, trigger: 'INTERMEDIATE_15M_OBSERVED' },
    ],
    isTerminal: false,
    canResetOnPolicyChange: false,
    canResetOnProviderOutage: false,
  ...
  // 2. Absorbing Censored Cases across the 5 censor reasons (§68.3)
  {
    ...
    transitions: [
      { step: 1, from: 'PENDING', to: 'CENSORED', valid: true, trigger: 'RIGHTS_DELETION_RECEIVED' },
      { step: 2, from: 'CENSORED', to: 'FULLY_MATURED', valid: false, trigger: 'ILLEGAL_RESURRECTION_ATTEMPT' },
    ],
    isTerminal: true,
    canResetOnPolicyChange: false,
    canResetOnProviderOutage: false,
  ...
  },
  {
    ...
    transitions: [
      { step: 1, from: 'PENDING', to: 'CENSORED', valid: true, trigger: 'MINT_COLLISION_UNRESOLVABLE' },
    ],
    isTerminal: true,
    canResetOnPolicyChange: false,
    canResetOnProviderOutage: false,
  ...
  },
  {
    ...
    transitions: [
      { step: 1, from: 'PENDING', to: 'PARTIALLY_MATURED', valid: true, trigger: 'INTERMEDIATE_TICKS' },
      { step: 2, from: 'PARTIALLY_MATURED', to: 'CENSORED', valid: true, trigger: 'COLLECTOR_GAP_UNRECOVERABLE' },
    ],
    isTerminal: true,
    canResetOnPolicyChange: false,
    canResetOnProviderOutage: false,
  ...
  },
  {
    ...
    transitions: [
      { step: 1, from: 'PENDING', to: 'CENSORED', valid: true, trigger: 'CORRUPTED_POOL_LAYOUT_V1' },
    ],
    isTerminal: true,
    canResetOnPolicyChange: false,
    canResetOnProviderOutage: false,
  ...
  },
  {
    ...
    transitions: [
      { step: 1, from: 'PENDING', to: 'CENSORED', valid: true, trigger: 'RPC_ARCHIVE_DROPPED_SLOT' },
    ],
    isTerminal: true,
    canResetOnPolicyChange: false,
    canResetOnProviderOutage: false,
  ...
  // 3. Absorbing Invalid Cases across the 5 invalid reasons (§68.3)
  {
    ...
    transitions: [
      { step: 1, from: 'PENDING', to: 'INVALID_DATA', valid: true, trigger: 'PROBABILITY_OUT_OF_BOUNDS_NAN' },
      { step: 2, from: 'INVALID_DATA', to: 'PENDING', valid: false, trigger: 'ILLEGAL_RESET_ATTEMPT' },
    ],
    isTerminal: true,
    canResetOnPolicyChange: false,
    canResetOnProviderOutage: false,
  ...
  },
  {
    ...
    transitions: [
      { step: 1, from: 'PENDING', to: 'INVALID_DATA', valid: true, trigger: 'EXIT_TIME_BEFORE_ACTION_TIME' },
    ],
    isTerminal: true,
    canResetOnPolicyChange: false,
    canResetOnProviderOutage: false,
  ...
  },
  {
    ...
    transitions: [
      { step: 1, from: 'PENDING', to: 'INVALID_DATA', valid: true, trigger: 'RESERVE_INVARIANT_VIOLATED' },
    ],
    isTerminal: true,
    canResetOnPolicyChange: false,
    canResetOnProviderOutage: false,
  ...
  },
  {
    ...
    transitions: [
      { step: 1, from: 'PENDING', to: 'INVALID_DATA', valid: true, trigger: 'CONFLICTING_MINT_DECIMALS_NO_CONSENSUS' },
    ],
    isTerminal: true,
    canResetOnPolicyChange: false,
    canResetOnProviderOutage: false,
  ...
  },
  {
    ...
    transitions: [
      { step: 1, from: 'PENDING', to: 'INVALID_DATA', valid: true, trigger: 'RECEIPT_TIMESTAMP_UNVERIFIED' },
    ],
    isTerminal: true,
    canResetOnPolicyChange: false,
    canResetOnProviderOutage: false,
  ...
  // 4. No-Reset Regression Cases (§68.1, FR-MAT-001)
  {
    ...
    finalState: 'FULLY_MATURED',
    transitions: [
      { step: 1, from: 'FULLY_MATURED', to: 'PENDING', valid: false, trigger: 'EVAL_POLICY_VERSION_BUMP' },
      { step: 2, from: 'FULLY_MATURED', to: 'PARTIALLY_MATURED', valid: false, trigger: 'RECONFIGURATION' },
    ],
    isTerminal: true,
    canResetOnPolicyChange: false,
    canResetOnProviderOutage: false,
  ...
  },
  {
    ...
    finalState: 'FULLY_MATURED',
    transitions: [
      { step: 1, from: 'FULLY_MATURED', to: 'CENSORED', valid: false, trigger: 'RPC_OUTAGE_POST_MATURITY' },
    ],
    isTerminal: true,
    canResetOnPolicyChange: false,
    canResetOnProviderOutage: false,
